...
def argument_parser():
    ...
    # Miscs
    # ************************************************************
    parser.add_argument('--save-dir', type=str, default='./result/miniImageNet/CAM/1-shot-seed1-resnet12-224')
    ...
    parser.add_argument('--train_nTestNovel', type=int, default=16 * 5,
