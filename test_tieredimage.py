...
parser.add_argument('--save-dir', type=str, default='/home/sunjiamei/work/fewshotlearning/fewshot-CAN-master/pretrained_model/tieredImageNet/5-shot/')
parser.add_argument('--resume', type=str, default='/home/sunjiamei/work/fewshotlearning/fewshot-CAN-master/pretrained_model/tieredImageNet/5-shot//best_model.pth.tar', metavar='PATH')
# FewShot settting
...
def test(model, testloader, use_gpu):
    ...
    with torch.no_grad():
        for batch_idx , (images_train, labels_train, images_test, labels_test) in enumerate(testloader):
            ...
            cls_scores = cls_scores.view(batch_size * num_test_examples, -1)   # 600, 5
