...
def argument_parser():
    ...
    parser.add_argument('--stepsize', default=[30], nargs='+', type=int,
                        help="stepsize to decay learning rate")
    parser.add_argument('--LUT_lr', default=[(20, 0.1), (30, 0.03), (40, 0.01), (50, 0.003), (60, 0.001),(70,0.0003),(80, 0.0001), (100, 0.00003)],  #(20, 0.1), (30, 0.01), (40, 0.005), (50, 0.0001), (55, 0.00005), (70, 0.00001)
    ...
    # Miscs
    # ************************************************************
    parser.add_argument('--save-dir', type=str, default='./result/miniImageNet/CAM/5-shot-seed112-resnet12-FM')
