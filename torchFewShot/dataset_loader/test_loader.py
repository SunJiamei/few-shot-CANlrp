...
class FewShotDataset_test(Dataset):
    ...
    def __getitem__(self, index):
        ...
        Xt, Yt, path_t = self._creatExamplesTensorData(Exemplars)
        Xe, Ye, path_e = self._creatExamplesTensorData(Tnovel)
        return Xt, Yt, Xe, Ye, path_e
