...
class Setdataset(object):
    ...
    def __init__(self, dataset_name):
        self.dataset_dir = f'/home/sunjiamei/work/fewshotlearning/dataset/{dataset_name}/'
        if not os.path.isdir(self.dataset_dir):
            raise ValueError('please specific dataset name using one of the options; [cars, cub, emnist, omniglot, miniImagenet, places, plantae, tired_imagenet]')
